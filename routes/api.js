...
try {
var zahirr = db.get("akari");
} catch (e) {
	console.log('')
}

var creatorList = ['@akari','@akarigans','@akari_ajalah','@akarianjay', '@akariganssss','@akariganteng','@akaricantikkk'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6281211651261 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'Akarigans') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Akarigans') return res.json(loghandler.invalidKey)
